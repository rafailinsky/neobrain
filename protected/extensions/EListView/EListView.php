<?php
  ...
  class EListView extends CListView
  {
    //Configurable PARAMS ------------------------------------------------------------------------------------------
    //--------------------------------------------------------------------------------------------------------------
    public $itemsPerPageMenu                 = array(); // [5,10,20,50,100,200,500]
    public $itemsPerPageMenuClass            = "ippm";  // Class name to aply to Item Per Page PullDown Menu 
    public $itemsPerPageMenuItemOptionPrefix = 5;      // PREFIX X SUFIX ie VIEW 10 Per Page
    public $itemsPerPageMenuItemOptionSufix  = 5;      // PREFIX X SUFIX ie VIEW 20 Per Page
    ...
    public $pageSize                         = 5; //Internal Use To Track Items per page 
    ...
    public function renderSummary()
    {
      ...
      if($this->enablePagination)
      {
        if(($summaryText=$this->summaryText)===null)
          $summaryText=Yii::t('zii','Viendo {start}-{end} de {count} resultados. {itemsPerPage}');
